...
class Options():
    ...
    def initialize(self, parser):
        # model parameters
        parser.add_argument('--netG', type=str, default='STDGAN', help='[STDGAN | resnet | Unet]')
        ...
        # basic parameters
        parser.add_argument('--task', type=str, default='internal_test', help='[iom | vnc]')
        parser.add_argument('--direction', type=str, default='image_to_label', help='image_to_label or label_to_image')
        parser.add_argument('--data_path', type=str, default='./data/CT/train/')
        parser.add_argument('--val_path', type=str, default='./data/CT/test/')
        ...
        parser.add_argument('--save_fre', type=int, default=5, help='checkpoint save frequency')
        ...
        parser.add_argument('--patch_size', default=[96, 128, 128], help='Size of the patches extracted from the image')
